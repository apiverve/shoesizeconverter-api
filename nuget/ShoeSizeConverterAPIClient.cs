...
namespace APIVerve.API.ShoeSizeConverter
{
    ...
    /// <summary>
    /// Client for the ShoeSizeConverter API
    /// </summary>
    public class ShoeSizeConverterAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/shoesizeconverter";
        ...
        {
            { "size", new ValidationRule { Type = "string", Required = true } },
        ...
        public ShoeSizeConverterAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ShoeSizeConverterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ShoeSizeConverterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ShoeSizeConverterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(ShoeSizeConverterQueryOptions options)
        {
        ...
        public ResponseObj Execute(ShoeSizeConverterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ShoeSizeConverterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ShoeSizeConverterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ShoeSizeConverterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ShoeSizeConverterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ShoeSizeConverterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(ShoeSizeConverterQueryOptions options)
        {
