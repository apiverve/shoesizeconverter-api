...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/shoesizeconverter',
        'Source': 'https://github.com/apiverve/shoesizeconverter-api',
        'Bug Tracker': 'https://github.com/apiverve/shoesizeconverter-api/issues'
    },
    classifiers=[
