...
class TestShoesizeconverterAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = ShoesizeconverterAPIClient(self.api_key)

    @patch('apiverve_shoesizeconverter.apiClient.requests.get')
