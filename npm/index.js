...
class shoesizeconverterWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/shoesizeconverter');
        }
        ...
        this.validationRules = {"size":{"type":"string","required":true},"from":{"type":"string","required":true},"gender":{"type":"string","required":false,"default":"unisex"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/shoesizeconverter`);
        }
    }
...
module.exports = shoesizeconverterWrapper;
