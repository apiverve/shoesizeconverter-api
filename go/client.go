// Package shoesizeconverter provides a Go client for the Shoe Size Converter API.
//
// For more information, visit: https://apiverve.com/marketplace/shoesizeconverter?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/shoesizeconverter"
	defaultTimeout = 30 * time.Second
)

// Client is the Shoe Size Converter API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Shoe Size Converter API client.
...
// Execute makes a request to the Shoe Size Converter API with typed parameters.
//
...
//   - size (required): string - The shoe size to convert
//   - from (required): string - Source region
//   - gender: string - Gender sizing
