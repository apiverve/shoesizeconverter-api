...
{
    class ShoeSizeConverterExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/shoesizeconverter";

        /// <summary>
        /// Make a GET request to the Shoe Size Converter API
        /// </summary>
        static async Task<JsonDocument> CallShoeSizeConverterAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;size&quot;] &#x3D; &quot;9&quot;, [&quot;from&quot;] &#x3D; &quot;us&quot;, [&quot;gender&quot;] &#x3D; &quot;men&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Shoe Size Converter API...\n");

            var result = await CallShoeSizeConverterAPI();
