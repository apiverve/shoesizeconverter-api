# Shoe Size Converter Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:shoesizeconverter-api:1.1.13'
}
```
...
ShoeSizeConverterAPIClient client = new ShoeSizeConverterAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/shoesizeconverter](https://docs.apiverve.com/ref/shoesizeconverter)
...
- **Documentation:** [https://docs.apiverve.com/ref/shoesizeconverter](https://docs.apiverve.com/ref/shoesizeconverter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/shoesizeconverter-api/issues)
